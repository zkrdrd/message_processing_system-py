...
def processor(PaymentMessages: MessagePayment):
    try:
        ValidationError().validate_required_fields(
            PaymentMessages.type_message, PaymentMessages.uid_message
        )
...
def test_processor_validation_error_1():
    ...
    assert isinstance(
        processor(MessagePayment("", "1A", "123", "321", 50)), ValidationError
    )
...
def test_processor_validation_error_2():
    ...
    assert isinstance(
        processor(
            MessagePayment(
                TypeMessageVariables.TYPE_MESSAGE_CREATED.value,
                "",
                "123",
                "321",
                50,
...
def test_processor_return_value_2():
    ...
    assert isinstance(
        processor(
            MessagePayment(
                TypeMessageVariables.TYPE_MESSAGE_PROCESSED.value,
                "1A",
                "",
                "",
                "",
...
def test_processor_validation_is_updated_1():
    ...
    assert isinstance(
        processor(
            MessagePayment(
                TypeMessageVariables.TYPE_MESSAGE_CANCELED.value,
                "1A",
                "",
                "",
                "",
